...
| [signatory-provenance-v1.json](signatory-provenance-v1.json) | Provenance analyst output from signatory's dogfood engagement (v1 schema, structured) | Output of the provenance handoff run against signatory itself on 2026-04-14. Validated end-to-end the `templates/handoffs/provenance-review-v1.md` template. Historical record; not currently referenced by tests. |
