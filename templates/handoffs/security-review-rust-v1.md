    ...
    "patterns": [
      {
        ...
        "description": "unsafe blocks lacking SAFETY comments per Rust API guidelines",
        "collector_hint": {
          "grep_precision": "high",
...
- `citations: ["src/main.rs:12"]` — citations are objects, not
  strings. Use `{"path": "src/main.rs", "line_start": 12}`.
